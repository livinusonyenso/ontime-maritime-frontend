            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-8">
                ...
                <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 px-5 py-2.5 rounded-full">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold tracking-wide text-cyan-400">LEGAL CHAMBER MARITIME</span>
                  </div>
                  <div className="w-px h-4 bg-white/30" />
                  <span className="text-sm text-white/80">Est. 2015</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-slate-300 max-w-lg leading-relaxed">
                    Expert legal counsel for shipping, offshore operations, and international maritime disputes. 
                    Your trusted partner in maritime legal excellence.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-8 pt-4">
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-3">
                      {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="w-10 h-10 rounded-full border-2 border-slate-900 bg-gradient-to-br from-slate-600 to-slate-800 flex items-center justify-center">
                          <span className="text-xs font-semibold text-white">{String.fromCharCode(64 + i)}</span>
                        </div>
                      ))}
                    </div>
                    <div className="ml-2">
                      <div className="text-white font-semibold">2,500+</div>
                      <div className="text-sm text-slate-400">Cases Won</div>
                    </div>
                  </div>
              ...
              <div className="hidden lg:block">
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
                  <h3 className="text-white text-xl font-semibold mb-6">Quick Legal Search</h3>
                  <div className="space-y-4">
                    <div className="relative">
                      <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400" />
                      <Input
                        placeholder="Search lawyers, templates, services..."
                        value={searchQuery}
                        onChange={(e) => dispatch(setSearchQuery(e.target.value))}
                        className="pl-12 h-14 bg-white/10 border-white/20 text-white placeholder:text-slate-400 rounded-xl focus:ring-2 focus:ring-cyan-400"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <Button 
                        variant="secondary" 
                        className="bg-white/10 text-white hover:bg-white/20 h-12 rounded-xl"
                        onClick={() => { setActiveTab("consultants"); dispatch(setSearchQuery("shipping")); }}
                      >
                      ...
                      <Button 
                        variant="secondary" 
                        className="bg-white/10 text-white hover:bg-white/20 h-12 rounded-xl"
                        onClick={() => { setActiveTab("consultants"); dispatch(setSearchQuery("cargo")); }}
                      >
                      ...
                      <Button 
                        variant="secondary" 
                        className="bg-white/10 text-white hover:bg-white/20 h-12 rounded-xl"
                        onClick={() => { setActiveTab("consultants"); dispatch(setSearchQuery("insurance")); }}
                      >
