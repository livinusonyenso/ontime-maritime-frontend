            ...
            <div className="grid gap-6 py-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-2 text-sm">
                  <div>
                    <span className="text-muted-foreground">Weight:</span> {selectedBol.grossWeight}kg
                  </div>
                  <div>
                    <span className="text-muted-foreground">Packages:</span> {selectedBol.numberOfPackages}
                  </div>
                  <div>
                    <span className="text-muted-foreground">Seal:</span> {selectedBol.sealNumber || "N/A"}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary/5 p-4 rounded-lg border border-primary/10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-primary">Blockchain Verification</span>
                </div>
                <div className="text-xs font-mono break-all bg-background p-2 rounded border">
                  {selectedBol.blockchainHash}
                </div>
                <div className="flex items-center gap-2 mt-2 text-xs text-muted-foreground">
                  <CheckCircle2 className="h-3 w-3 text-green-500" />
                  Verified on Ethereum Mainnet • Block #18239402
                </div>
              </div>
            </div>

            <DialogFooter>
              <Button variant="outline" onClick={() => dispatch(clearSelectedBol())}>
                Close
              </Button>
              <Button>
