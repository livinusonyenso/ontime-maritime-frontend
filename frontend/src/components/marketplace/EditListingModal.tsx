...
import { updateListing, selectSellerSubmitting, selectSellerListingsError } from "@/store/slices/sellerListingSlice"
...
export function EditListingModal({ open, onClose, listing }: EditListingModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (images.length === 0) {
      setLocalError("Please upload at least one image"); return
    }
    ...
    const result = await (dispatch as any)(updateListing({
      id: listing.id,
      title, description,
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed rounded-lg p-4">
              <Input type="file" accept="image/*" multiple onChange={handleImageUpload}
                className="hidden" id="image-upload-edit" disabled={images.length >= 5} />
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed rounded-lg p-4">
              <Input type="file" accept="image/*,application/pdf" onChange={handleBolUpload}
                className="hidden" id="bol-upload-edit" />
              <Label htmlFor="bol-upload-edit" className="flex flex-col items-center justify-center cursor-pointer">
                {bolImage ? (
